...
\section{A Case Study: Bidirectional Simply Typed \texorpdfstring{$\lambda$}{lambda}-Calculus}\label{sec:bi-stlc}
\begin{figure}
  \centering
  \small
  \begin{mathpar}
...
\begin{LTannote}{deriving from annotation}
  deriving bidirectional binding signature from annotation
\end{LTannote}
...
\subsection{Type Synthesis and Checking}
