...
\begin{corollary}[Trichotomy of Raw Terms]
  ...
  \begin{enumerate}
    \item $t$ has a synthesis mode and there exists a typing derivation of $\Gamma \vdash_{\Sigma, \Omega} t : A$ for some type $A$.
    \item $t$ has a synthesis mode but there is no typing derivation of $\Gamma \vdash_{\Sigma, \Omega} t : A$ for any type $A$.
    \item $t$ does not have a synthesis mode.
  \end{enumerate}
\end{corollary}
\begin{proof}
