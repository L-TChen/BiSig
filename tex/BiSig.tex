...
\newcommand{\LT}[1]{\todo[author=LT,inline,color=orange!40,caption={}]{{#1}}}
\newcommand{\Josh}[1]{\todo[author=Josh,inline,color=yellow!40,caption={}]{{#1}}}
...
\begin{abstract}
  ...
  In response to this difficulty, we develop a \emph{simple} yet \emph{general} and \emph{constructive} theory of bidirectional type synthesis where \emph{bidirectional type synthesis} refers to the mutual use of type checking and inference based on bidirectional typing rules to determine the type of a program with type annotations.
  ...
  Specifically, `the proof' of logical decidability of type synthesis is instantiated to a type synthesiser for the simple type theory specified by a valid signature, analogous to a parser generator.
  We introduce the notion of bidirectionalisation to refine annotatability in bidirectional typing.
  Type synthesis and bidirectionalisation result in the trichotomy of raw terms, which models a practical type synthesiser that may throw an exception to locate missing annotations.
