...
\begin{abstract}
  ...
  Type synthesis and bidirectionalisation result in the trichotomy of raw terms, which models a practical type synthesiser that may throw an exception and locate missing annotations.
