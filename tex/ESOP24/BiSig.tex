\documentclass[orivec,envcountsame,envcountsect,oribibl]{llncs}
...
%\spnewtheorem{theorem}{Theorem}[section]{\bfseries}{}
%\spnewtheorem{definition}{Definition}[section]{\bfseries}{}
...
%  \thanks{The work is supported by the National Science and Technology Council of Taiwan under grant NSTC 112-2221-E-001-003-MY3.}
}
...
Soundness, completeness, and mode-correctness are studied universally for al signatures, which are sufficient conditions for deriving a type synthesiser.
