...
\LT{emphasise that formalisation and verification are important}
...
\LT{emphasise that our proof is an actual program}
...
To make the notion of mode-correctness precise, we exhibit a general definition of bidirectional simple type systems which extends the sorted version of \varcitet{Aczel1978}{'s binding signature} with bidirectionality.
...
\LT{methodology for combining proofs and programs?}
