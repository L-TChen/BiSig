...
\LT{some GitHub issues \cite{Felicissimo2023}}
...
To make the notion of mode-correctness precise, we give a general definition of bidirectional simple type systems, called \emph{bidirectional binding signature}, which extends the sorted version of \varcitet{Aczel1978}{'s binding signature} with bidirectionality.
