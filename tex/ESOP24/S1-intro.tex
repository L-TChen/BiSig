...
By adding assumptions, it should be possible to extend the theory to deal with more expressive type systems; for instance, we briefly discuss how the theory can handle polymorphically typed languages such as \SystemF and \SystemFsub with additional assumptions in \cref{sec:future}.
