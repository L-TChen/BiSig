...
Our work adopts a proof-relevant approach to (bidirectional) type synthesis, as illustrated by \citet{Wadler2022} for simply typed $\lambda$-calculus with natural numbers.
...
\begin{enumerate}
  ...
  \item mode derivations for explicitly dealing with annotations in the theory (in particular leading to a more natural and useful version of completeness than \varcitet{Dunfield2021}{'s annotatability}), and mode decoration for helping the user to work with annotations in practice;
