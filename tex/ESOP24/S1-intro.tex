...
In their survey paper, \varcitet{Dunfield2021}{ summarised} the principles of bidirectional type synthesis and its wide coverage of languages with simple, polymorphic, dependent, and gradual types, among others.
