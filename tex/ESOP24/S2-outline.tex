...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \and
    \inferrule{V \vdash \isTerm{t}}{V \vdash \isTerm{(t \annotatecolon A)}}\,\Rule{Anno}
    \and
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \and
    \inferrule{\Gamma \vdash \isTerm{t} : A}{\Gamma \vdash \isTerm{(t \annotatecolon A)} : A}\,\Rule{Anno}
    \and
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \and
    \inferrule{\Gamma \vdash \isTerm{t} \chk A}{\Gamma \vdash \isTerm{(t \annotatecolon A)}\syn A}\,\SynRule{Anno}
    \and
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \and
    \inferrule{V |- \isTerm{t}^{\chk}}{V |- (\isTerm{t \annotatecolon A})^{\syn}}\,\SynRule{Anno}
    \and
...
A \emph{mode decorator} decides for any raw term~$V \vdash \isTerm{t}$ if $V \vdash \isTerm{t}^{\syn}$.
\end{defn}
