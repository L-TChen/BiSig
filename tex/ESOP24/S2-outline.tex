...
We will construct a mode decorator~(\cref{sec:mode-decoration}) and a bidirectional type synthesiser~(\cref{sec:type-synthesis}) and prove the above theorem~(\cref{sec:soundness-and-completeness}) for all syntax-directed bidirectional simple type systems.
