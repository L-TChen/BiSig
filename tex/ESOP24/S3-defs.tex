...
\begin{definition}[{\cite[p.~322]{Fiore2010}}]\label{def:binding-arity}
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \and
    \inferrule{\rho : \Sub{\Xi}{\emptyset} \and  \Gamma, \vec{\isTerm{x}}_\isTerm{1} : \simsub{\Delta_{1}}{\rho} |-_{\Sigma, \Omega} \isTerm{t_1} : \simsub{A_{1}}{\rho} \and \cdots\and \Gamma, \vec{\isTerm{x}}_\isTerm{n} : \simsub{\Delta_{n}}{\rho} |-_{\Sigma, \Omega} \isTerm{t_n} : \simsub{A_{n}}{\rho}}
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \\
    \inferrule{\rho\colon \Sub{\Xi}{\emptyset} \and \Gamma, \simsub{\vars{x}_\isTerm{1} : \Delta_{1}}{\rho} |-_{\Sigma, \Omega} \isTerm{t_{1}} :^\dir{d_1} \simsub{A_1}{\rho} \and
      \cdots \and
