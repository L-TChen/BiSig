...
Mode-correctness can be proved by applying \cref{lem:decidability-mode-correctness} and its type synthesiser is derived directly by \cref{cor:trichotomy} with the specification~$(\Sigma, \Omega)$.
