...
A spine application, denoted as $t\;u_1\;\ldots\;u_n$, is a variant of application that consists of a head term $t$ and an indefinite number of arguments $u_1\;u_2\;\dots\;u_n$.
This arrangement allows direct access to the head term, making it practical in various applications.
For instance, \Agda's core language employs this form of applications, as does its reflected syntax used for metaprogramming.

At first glance, accommodating this form of application may seem impossible, given the number of arguments a construct can accept is finite as specified by a signature.
