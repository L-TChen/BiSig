...
We briefly sketch our \Agda formalisation in \cref{sec:formalisation}.
Finally, in \cref{sec:future} we reflect on techniques that may improve the formal development and potential challenges in extending our theory to a more general setting.
