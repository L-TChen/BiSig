...
\citet[Section~3.2]{Dunfield2021} formulated completeness differently from ours (\cref{thm:STLC-completeness,sec:soundness-and-completeness}) and proposed \emph{annotatability} as a more suitable name.
