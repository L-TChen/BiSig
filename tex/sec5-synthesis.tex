...
\Cref{subsec:mode-correctness} formalises the concept of mode-correctness and establishes the uniqueness of synthesised types.
...
\end{corollary}
\begin{proof}
  Combine  \Cref{thm:soundness,thm:completeness,thm:mode-preprocessing} with \Cref{thm:bidirectional-type-synthesis}.
