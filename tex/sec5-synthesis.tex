...
\begin{corollary}[Trichotomy of Raw Terms]\label{cor:trichotomy}
  Let $(\Sigma, \Omega)$ be a mode-correct bidirectional type system.
...
\end{corollary}
\begin{proof}
  Combine  \Cref{thm:term-soundness,thm:term-completeness,thm:mode-preprocessing} with \Cref{thm:bidirectional-type-synthesis}.
