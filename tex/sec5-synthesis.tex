...
\begin{proof}[Proof of {\Cref{thm:bidirectional-type-synthesis-checking}}]
  ...
  \end{itemize}
\end{proof}
While the proof presented above is intricate, its formal counterpart essentially functions as two programs for type checking and synthesis.
...
If a contradiction proof is not of interest for implementation, the programs can be simplified by disregarding the cases that yield such contradiction proofs.
