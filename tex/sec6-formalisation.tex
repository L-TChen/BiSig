...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{constructor}\;\Varid{sigd}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Keyword{field}{}\<[E]%
\\
...
At last, we can define the type of bidirectional typing derivations for a signature \ensuremath{\Conid{D}} using \ensuremath{\Varid{⟦}\;\Conid{D}\;\Varid{⟧}}, similarly to how we handled simple types and raw terms. This involves the following four constructors, corresponding to rules $\SynRule{Var}$, $\SynRule{Anno}$, $\ChkRule{Sub}$, and $\Rule{Op}$ in \Cref{fig:extrinsic-typing}.
{\small\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
...
\>[9]{}\mathbin{:}\;(\Conid{A}\;\mathbin{:}\;\Conid{Ty})\;{}\<[56]%
\>[56]{}\Varid{op}\;{}\<[62]%
\>[62]{}\mathbin{:}\;\Varid{⟦}\;\Conid{D}\;\Varid{⟧}\;\Conid{Raw}\;\Varid{\char95 ⊢\char95 [\char95 ]\char95 }\;\Conid{Γ}\;\Varid{rs}\;\Varid{d}\;\Conid{A}\;{}\<[E]%
\\
\>[9]{}\Varid{→}\;\Conid{Γ}\;\Varid{⊢}\;\Varid{r}\;{}\<[24]%
\>[24]{}\Varid{⇐}\;\Conid{A}\;{}\<[62]%
\>[62]{}\Varid{→}\;\Conid{Γ}\;\Varid{⊢}\;\Varid{op}\;\Varid{rs}\;[\mskip1.5mu \;\Varid{d}\;\mskip1.5mu]\;\Conid{A}\;{}\<[E]%
\\
...
For the $\SynRule{Sub}$ case, the induction hypothesis \ensuremath{\Varid{soundness}\;\Varid{t}} is invoked directly.
