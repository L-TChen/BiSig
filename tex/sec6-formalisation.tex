...
\\[\blanklineskip]%
\>[B]{}\Keyword{data}\;\Conid{Tm}\;(\Conid{Θ}\;\mathbin{:}\;\Conid{ℕ})\;\mathbin{:}\;\Conid{Set}\;\Keyword{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\text{\textasciigrave}\anonymous \;{}\<[8]%
\>[8]{}\mathbin{:}\;\Conid{Fin}\;\Conid{Θ}\;{}\<[24]%
\>[24]{}\Varid{→}\;\Conid{Tm}\;\Conid{Θ}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{op}\;{}\<[8]%
\>[8]{}\mathbin{:}\;\Varid{⟦}\;\Conid{D}\;\Varid{⟧}\;(\Conid{Tm}\;\Conid{Θ})\;{}\<[24]%
\>[24]{}\Varid{→}\;\Conid{Tm}\;\Conid{Θ}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
  \end{minipage}
...
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{args}\;{}\<[14]%
\>[14]{}\mathbin{:}\;\Conid{List}\;(\Conid{ArgD}\;\Varid{vars}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{type}\;{}\<[14]%
\>[14]{}\mathbin{:}\;\Conid{TExp}\;\Varid{vars}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{mode}\;{}\<[14]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{⟦\char95 ⟧ᶜ}\;{}\<[8]%
\>[8]{}\mathbin{:}\;\Conid{ConD}\;{}\<[19]%
\>[19]{}\Varid{→}\;\Conid{Fam}\;\Varid{→}\;\Conid{Fam}{}\<[E]%
\\
\>[B]{}\Varid{⟦}\;\Varid{ι}\;\anonymous \;\Conid{D}\;{}\<[17]%
\>[17]{}\Varid{⟧ᶜ}\;{}\<[22]%
\>[22]{}\Conid{X}\;{}\<[27]%
\>[27]{}\mathrel{=}\;\Varid{⟦}\;\Conid{D}\;\Varid{⟧ᵃˢ}\;\Conid{X}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{⟦\char95 ⟧}\;{}\<[8]%
\>[8]{}\mathbin{:}\;\Conid{Desc}\;{}\<[19]%
\>[19]{}\Varid{→}\;\Conid{Fam}\;\Varid{→}\;\Conid{Fam}{}\<[E]%
\\
\>[B]{}\Varid{⟦}\;\Conid{D}\;{}\<[17]%
\>[17]{}\Varid{⟧}\;{}\<[22]%
\>[22]{}\Conid{X}\;\Varid{n}\;{}\<[27]%
\>[27]{}\mathrel{=}\;\Conid{Σ[}\;\Varid{i}\;\Varid{∈}\;\Conid{D}\;\Varid{.Op}\;\mskip1.5mu]\;\Varid{⟦}\;\Conid{D}\;\Varid{.rules}\;\Varid{i}\;\Varid{⟧ᶜ}\;\Conid{X}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
  \end{minipage}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\text{\textasciigrave}\anonymous \;{}\<[7]%
\>[7]{}\mathbin{:}\;\Conid{Fin}\;\Varid{n}\;{}\<[32]%
\>[32]{}\Varid{→}\;\Conid{Raw}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{\char95 ∋\char95 }\;\mathbin{:}\;(\Conid{A}\;\mathbin{:}\;\Conid{Ty})\;(\Varid{t}\;\mathbin{:}\;\Conid{Raw}\;\Varid{n})\;{}\<[32]%
\>[32]{}\Varid{→}\;\Conid{Raw}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{op}\;{}\<[7]%
\>[7]{}\mathbin{:}\;\Varid{⟦}\;\Conid{D}\;\Varid{⟧}\;\Conid{Raw}\;\Varid{n}\;{}\<[32]%
\>[32]{}\Varid{→}\;\Conid{Raw}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
  \end{minipage}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{⟦\char95 ⟧ᵃ}\;{}\<[7]%
\>[7]{}\mathbin{:}\;(\Conid{Δ}\;\mathbin{:}\;\Conid{TExps}\;\Conid{Ξ})\;(\Conid{X}\;\mathbin{:}\;\Conid{R.Fam})\;(\Conid{Y}\;\mathbin{:}\;(\Conid{Γ}\;\mathbin{:}\;\Conid{Cxt}\;\Varid{0}){}\<[E]%
\\
\>[7]{}\Varid{→}\;\Conid{X}\;(\Varid{length}\;\Conid{Γ})\;\Varid{→}\;\Conid{Set})\;{}\<[E]%
\\
\>[7]{}\Varid{→}\;\Conid{TSub}\;\Conid{Ξ}\;\Varid{0}\;\Varid{→}\;(\Conid{Γ}\;\mathbin{:}\;\Conid{Cxt}\;\Varid{0})\;\Varid{→}\;\Conid{R.⟦}\;\Conid{Δ}\;\Varid{⟧ᵃ}\;\Conid{X}\;(\Varid{length}\;\Conid{Γ})\;{}\<[E]%
\\
\>[7]{}\Varid{→}\;\Conid{Set}{}\<[E]%
\\
\>[B]{}\Varid{⟦}\;\Varid{[]}\;{}\<[17]%
\>[17]{}\Varid{⟧ᵃ}\;\Conid{X}\;\Conid{Y}\;\Varid{σ}\;\Conid{Γ}\;\Varid{x}\;{}\<[39]%
\>[39]{}\mathrel{=}\;\Conid{Y}\;\Conid{Γ}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{⟦}\;\Conid{A}\;\Varid{∷}\;\Conid{Δ}\;{}\<[17]%
\>[17]{}\Varid{⟧ᵃ}\;\Conid{X}\;\Conid{Y}\;\Varid{σ}\;\Conid{Γ}\;\Varid{x}\;{}\<[39]%
\>[39]{}\mathrel{=}\;\Varid{⟦}\;\Conid{Δ}\;\Varid{⟧ᵃ}\;\Conid{X}\;\Conid{Y}\;\Varid{σ}\;((\Conid{A}\;\Varid{⟨}\;\Varid{σ}\;\Varid{⟩})\;\Varid{∷}\;\Conid{Γ})\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{⟦\char95 ⟧ᵃˢ}\;\mathbin{:}\;(\Conid{D}\;\mathbin{:}\;\Conid{ArgsD}\;\Conid{Ξ})\;(\Conid{X}\;\mathbin{:}\;\Conid{R.Fam})\;(\Conid{Y}\;\mathbin{:}\;\Conid{Fam}\;\Conid{X})\;{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{→}\;\Conid{TSub}\;\Conid{Ξ}\;\Varid{0}\;\Varid{→}\;(\Conid{Γ}\;\mathbin{:}\;\Conid{Cxt}\;\Varid{0})\;\Varid{→}\;\Conid{R.⟦}\;\Conid{D}\;\Varid{⟧ᵃˢ}\;\Conid{X}\;(\Varid{length}\;\Conid{Γ})\;\Varid{→}\;\Conid{Set}{}\<[E]%
\\
\>[B]{}\Varid{⟦}\;\Varid{[]}\;{}\<[17]%
\>[17]{}\Varid{⟧ᵃˢ}\;\anonymous \;\anonymous \;\anonymous \;\anonymous \;\anonymous \;{}\<[39]%
\>[39]{}\mathrel{=}\;\Varid{⊤}{}\<[E]%
\\
\>[B]{}\Varid{⟦}\;(\Conid{Δ}\;\Varid{⊢}\;\Conid{A})\;\Varid{∷}\;\Conid{Ds}\;{}\<[17]%
\>[17]{}\Varid{⟧ᵃˢ}\;\Conid{X}\;\Conid{Y}\;\Varid{σ}\;\Conid{Γ}\;(\Varid{x}\;\Varid{,}\;\Varid{xs})\;{}\<[39]%
\>[39]{}\mathrel{=}\;{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{⟦}\;\Conid{Δ}\;\Varid{⟧ᵃ}\;\Conid{X}\;(\Varid{λ}\;\iden{\Conid{Γ}^\prime}\;\iden{\Varid{x}^\prime}\;\Varid{→}\;\Conid{Y}\;\iden{\Conid{Γ}^\prime}\;\iden{\Varid{x}^\prime}\;(\Conid{A}\;\Varid{⟨}\;\Varid{σ}\;\Varid{⟩}))\;\Varid{σ}\;\Conid{Γ}\;\Varid{x}\;\Varid{×}\;\Varid{⟦}\;\Conid{Ds}\;\Varid{⟧ᵃˢ}\;\Conid{X}\;\Conid{Y}\;\Varid{σ}\;\Conid{Γ}\;\Varid{xs}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{⟦\char95 ⟧ᶜ}\;\mathbin{:}\;(\Conid{D}\;\mathbin{:}\;\Conid{ConD})\;(\Conid{X}\;\mathbin{:}\;\Conid{R.Fam})\;(\Conid{Y}\;\mathbin{:}\;\Conid{Fam}\;\Conid{X})\;\Varid{→}\;\Conid{Fam}\;\iden{\Varid{ℓ}^\prime}\;(\Conid{R.⟦}\;\Conid{D}\;\Varid{⟧ᶜ}\;\Conid{X}){}\<[E]%
\\
\>[B]{}\Varid{⟦}\;\Varid{ι}\;\{\mskip1.5mu \Conid{Ξ}\mskip1.5mu\}\;\Conid{B}\;\Conid{D}\;{}\<[17]%
\>[17]{}\Varid{⟧ᶜ}\;\Conid{X}\;\Conid{Y}\;\Conid{Γ}\;\Varid{xs}\;\Conid{A}\;{}\<[39]%
\>[39]{}\mathrel{=}\;{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Conid{Σ[}\;\Varid{σ}\;\Varid{∈}\;\Conid{TSub}\;\Conid{Ξ}\;\Varid{0}\;\mskip1.5mu]\;\Conid{B}\;\Varid{⟨}\;\Varid{σ}\;\Varid{⟩}\;\Varid{≡}\;\Conid{A}\;\Varid{×}\;\Varid{⟦}\;\Conid{D}\;\Varid{⟧ᵃˢ}\;\Conid{X}\;\Conid{Y}\;\Varid{σ}\;\Conid{Γ}\;\Varid{xs}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{⟦\char95 ⟧}\;\mathbin{:}\;(\Conid{D}\;\mathbin{:}\;\Conid{Desc})\;(\Conid{X}\;\mathbin{:}\;\Conid{R.Fam})\;(\Conid{Y}\;\mathbin{:}\;\Conid{Fam}\;\Conid{X})\;\Varid{→}\;\Conid{Fam}\;(\Conid{R.⟦}\;\Conid{D}\;\Varid{⟧}\;\Conid{X}){}\<[E]%
\\
\>[B]{}\Varid{⟦}\;\Conid{D}\;{}\<[17]%
\>[17]{}\Varid{⟧}\;\Conid{X}\;\Conid{Y}\;\Conid{Γ}\;(\Varid{i}\;\Varid{,}\;\Varid{xs})\;\Conid{A}\;{}\<[39]%
\>[39]{}\mathrel{=}\;\Varid{⟦}\;\Conid{D}\;\Varid{.rules}\;\Varid{i}\;\Varid{⟧ᶜ}\;\Conid{X}\;\Conid{Y}\;\Conid{Γ}\;\Varid{xs}\;\Conid{A}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{figure}
\begin{figure}[H]
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Keyword{data}\;\Varid{\char95 ⊢\char95 ⦂\char95 }\;\mathbin{:}\;\Conid{Fam₀}\;\Conid{Raw}\;\Keyword{where}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{var}\;{}\<[8]%
\>[8]{}\mathbin{:}\;(\Varid{i}\;\mathbin{:}\;\Conid{A}\;\Varid{∈}\;\Conid{Γ})\;{}\<[E]%
\\
\>[8]{}\Varid{→}\;\{\mskip1.5mu \Varid{j}\;\mathbin{:}\;\Conid{Fin}\;(\Varid{length}\;\Conid{Γ})\mskip1.5mu\}\;{}\<[E]%
\\
\>[8]{}\Varid{→}\;\Conid{L.index}\;\Varid{i}\;\Varid{≡}\;\Varid{j}\;{}\<[E]%
\\
\>[8]{}\Varid{→}\;\mbox{\onelinecomment }{}\<[E]%
\\
\>[8]{}\hsindent{2}{}\<[10]%
\>[10]{}\Conid{Γ}\;\Varid{⊢}\;(\text{\textasciigrave}\;\Varid{j})\;\Varid{⦂}\;\Conid{A}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
  \end{minipage}
\begin{minipage}[t]{.47\textwidth}
...
\>[8]{}\mathbin{:}\;(\Conid{A}\;\mathbin{:}\;\Conid{Ty})\;{}\<[E]%
\\
\>[8]{}\Varid{→}\;\Conid{Γ}\;\Varid{⊢}\;\Varid{r}\;\Varid{⦂}\;\Conid{A}\;{}\<[E]%
\\
\>[8]{}\Varid{→}\;\mbox{\onelinecomment }{}\<[E]%
\\
\>[8]{}\hsindent{2}{}\<[10]%
\>[10]{}\Conid{Γ}\;\Varid{⊢}\;(\Conid{A}\;\Varid{∋}\;\Varid{r})\;\Varid{⦂}\;\Conid{A}{}\<[E]%
\\
\>[3]{}\Varid{op}\;{}\<[8]%
\>[8]{}\mathbin{:}\;\Varid{⟦}\;\Conid{D}\;\Varid{⟧}\;\Conid{Raw}\;\Varid{\char95 ⊢\char95 ⦂\char95 }\;\Conid{Γ}\;\Varid{rs}\;\Conid{A}\;{}\<[E]%
\\
\>[8]{}\Varid{→}\;\mbox{\onelinecomment }{}\<[E]%
\\
\>[8]{}\hsindent{2}{}\<[10]%
\>[10]{}\Conid{Γ}\;\Varid{⊢}\;\Varid{op}\;\Varid{rs}\;\Varid{⦂}\;\Conid{A}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
  \end{minipage}
\end{figure}
...
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{→}\;\mbox{\onelinecomment }{}\<[E]%
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\Conid{Γ}\;\Varid{⊢}\;(\text{\textasciigrave}\;\Varid{j})\;\Varid{⇒}\;\Conid{A}{}\<[E]%
\\[\blanklineskip]%
\>[3]{}\hsindent{2}{}\<[5]%
...
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\Conid{Γ}\;\Varid{⊢}\;\Varid{r}\;\Varid{⇐}\;\Conid{A}{}\<[E]%
\\[\blanklineskip]%
\>[5]{}\Varid{op}\;{}\<[9]%
...
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\Conid{Γ}\;\Varid{⊢}\;\Varid{op}\;\Varid{rs}\;[\mskip1.5mu \;\Varid{d}\;\mskip1.5mu]\;\Conid{A}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
